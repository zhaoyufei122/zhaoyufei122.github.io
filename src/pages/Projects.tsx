...
import { ExternalLink, Github, FolderGit2, Play } from 'lucide-react';
                      ...
                      <div className="flex items-center gap-3 shrink-0">
                        ...
                        {'relatedLinks' in project && project.relatedLinks?.map((link) => (
                          <a
                            ...
                            target="_blank"
                            rel="noreferrer"
                            className="flex items-center gap-1.5 rounded-md border border-zinc-200 bg-zinc-50 px-2.5 py-1.5 text-xs font-medium text-zinc-600 transition-colors hover:border-emerald-500/40 hover:text-emerald-600 dark:border-zinc-700 dark:bg-zinc-800/50 dark:text-zinc-300 dark:hover:text-emerald-400"
