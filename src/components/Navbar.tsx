...
import { Terminal, Bot, BookOpen, Github, Mail, FileText } from 'lucide-react';
    ...
    <nav className="fixed top-0 w-full z-50 bg-zinc-950/80 backdrop-blur-md border-b border-zinc-800">
      <div className="max-w-5xl mx-auto px-6 h-16 flex items-center justify-between">
        <Link to="/" className="flex items-center gap-2 group">
          ...
          <span className="font-mono font-semibold text-zinc-100 tracking-tight hidden sm:inline-block">
              ...
              >
                ...
                {isActive && (
                  <motion.div
                    ...
                    className="absolute -bottom-[21px] left-0 right-0 h-[2px] bg-emerald-400"
                    initial={false}
